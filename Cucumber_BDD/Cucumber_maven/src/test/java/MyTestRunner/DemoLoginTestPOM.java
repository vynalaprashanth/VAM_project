...
public class DemoLoginTestPOM {
	...
	public void browser_is_opened() throws InterruptedException {
		...
		//create an instance for POMDemo class
	...
	// ^ and $ symbols are used in between username and password to run 1 by 1
	// credentials
	@When("^user enters (.*) and  (.*)$")
	public void user_enters_username_and_password(String username, String password) throws InterruptedException {
	
		 pomd = new POMDemo(driver);

		pomd.enterUsername(username);
		pomd.enterPassword(password);
//		driver.findElement(By.id("name")).sendKeys(username);

		// Taking Password from the sentence and sending the password into the element
		// dialogue box
